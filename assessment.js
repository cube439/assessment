...
() => {
    ...
    resultDivision.innerText = ''//divタグを空にすることでテキストをリセットして表示する
...
script.setAttribute('src',"assessment.js");
tweetDivision.appendChild(script);



//アロー関数→funcitonの省略形の無名関数、()=>で表す
...
//厳格モードを使うと変数宣言をしなくてもエラーが起きない、書き間違いが変数の宣言になる、const（定数、再代入ができない）return返す,str（文字列を保存する変数）sum（文字コードを足す変数）